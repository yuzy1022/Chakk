...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage message) {
        Log.e(TAG, "message" + message.getFrom());
        Log.e(TAG, "message" + message.getPriority());
        Log.e(TAG, "message" + message.getRawData());
        Log.e(TAG, "message notification : " + message.getNotification());
